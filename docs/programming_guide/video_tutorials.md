Below is a set of six lessons that show how to build a simple VR game using the SXR SDK. The sessions are 10 - 20 minutes long and show live demonstrations of SXR programming.
