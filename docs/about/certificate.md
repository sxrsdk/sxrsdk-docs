SXR DCO and signed-off-by process

The SXR SDK project uses the signed-off-by language and process used by the Linux kernel, to give us a clear chain of trust for every patch received.

```
SXR Developer's Certificate of Origin 1.0
...
```
SXR-DCO-1.0-Signed-off-by: Random J Developer
